...
export const BODY_CATALOG = Object.freeze({
  ...
  earth: Object.freeze({
    ...
    kind: 'terrestrial',
    parent: 'sun',
    inventoryMode: 'reference-only',
    launchPhase: 99,
    enabled: false,
    grid: null,
    basePriceCents: null,
    registryLabel: 'Earth Reference Map',
    indexLabel: null,
    dataSources: ['NASA', 'USGS'],
  }),
  mars: Object.freeze({
    id: 'mars',
    name: 'Mars',
  ...
  uranus: Object.freeze({
    ...
    grid: null,
    basePriceCents: null,
    registryLabel: 'Uranus Observation Registry',
    indexLabel: 'Uranus Index',
    dataSources: ['NASA PDS', 'JPL planetary maps'],
  }),
  neptune: Object.freeze({
    ...
    grid: null,
    basePriceCents: null,
    registryLabel: 'Neptune Observation Registry',
    indexLabel: 'Neptune Index',
    dataSources: ['NASA PDS', 'JPL planetary maps'],
  }),
  sun: Object.freeze({
    id: 'sun',
